...
export default async function GuideArticlePage({ params }: GuideArticlePageProps) {
  ...
  const structuredData = { "@context": "https://schema.org", "@graph": [
    { "@type": "Article", headline: article.title, description: article.seoDescription, datePublished: article.publishedAt, mainEntityOfPage: articleUrl, url: articleUrl, publisher: { "@type": "Organization", name: BRAND_NAME, url: SITE_URL } },
    { "@type": "BreadcrumbList", itemListElement: [
      { "@type": "ListItem", position: 1, name: "홈", item: `${SITE_URL}/` },
      { "@type": "ListItem", position: 2, name: "운영 노하우", item: `${SITE_URL}/guide/` },
  ...
  return <main className="guide-article-page">
    ...
    <SiteFooter/><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(structuredData) }}/>
  </main>;
}
